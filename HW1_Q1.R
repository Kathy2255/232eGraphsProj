...
#######(a)
# create random graph
g1 <- random.graph.game(1000, p[1], directed=F);
g2 <- random.graph.game(1000, p[2], directed=F);
g3 <- random.graph.game(1000, p[3], directed=F);
...
plot(pl , type="o", col="blue",main="Density function for G1(with p=0.01)",xlab="mids",ylab="Probability Density")
pl2 <- data.frame(x=h2$mids, y=h2$density)
plot(pl2 , type="o", col="blue",main="Density function for G2(with p=0.05)",xlab="mids",ylab="Probability Density")
pl3 <- data.frame(x=h3$mids, y=h3$density)
plot(pl3 , type="o", col="blue",main="Density function for G3(with p=0.1)",xlab="mids",ylab="Probability Density")
